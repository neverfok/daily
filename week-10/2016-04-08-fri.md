...
* Get the [HTML5 and CSS](https://www.freecodecamp.com/map#nested-collapseHTML5andCSS)
  section at least as far as the form :)
...
If you're wanting to do more of these, choose from among:
...
* [Intermediate Algorithm Scripting](https://www.freecodecamp.com/map#nested-collapseIntermediateAlgorithmScripting)

Wait on the jQuery for now, because we have someone from TableXI coming
to talk about react.js, and he requested that we don't do jQuery until
he's had the opportunity to talk to us.
